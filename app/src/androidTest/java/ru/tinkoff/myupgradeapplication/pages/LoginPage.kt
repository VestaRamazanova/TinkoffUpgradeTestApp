...
class LoginPage : BasePage() {
    ...
    private companion object {
        const val LOGIN_FIELD_RES = "ru.tinkoff.myupgradeapplication:id/edittext_login"
        const val PASSWORD_FIELD_RES = "ru.tinkoff.myupgradeapplication:id/edittext_password"
        const val SUBMIT_BUTTON_RES = "ru.tinkoff.myupgradeapplication:id/button_submit"
        const val PREVIOUS_BUTTON_RES = "ru.tinkoff.myupgradeapplication:id/button_second"
    }
}